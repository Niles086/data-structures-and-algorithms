...
const newStuff = (obj) => {
  const { radio, tv, cars, ...rest } = obj;
  const newCars = [...cars, 'Ford'];
  return { radio, tv, cars: newCars, ...rest };
};
...
let newState = (obj) => {
const { people, stuff,...rest } = obj;
const newPeople = ['Odie', ...people, 'Garfield'];
const { radio, tv, cars, ...rest2 } = stuff;
const newCars = [...cars, 'Ford'];
return { people: newPeople, stuff: { radio, tv, cars: newCars, ...rest2 }, ...rest };
};
