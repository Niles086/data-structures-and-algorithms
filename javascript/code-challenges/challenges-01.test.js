...
const addExclamation = (arr) => {
  ...
  const stringWithExclamation = [];
  arr.forEach(string => {
    stringWithExclamation.push(string + '!');
  });
  return stringWithExclamation;
};
...
const allUpperCase = (arr) => {
  const convertedToUpperCase = [];
  arr.forEach(string => {
    convertedToUpperCase.push(string.toUpperCase());
  });
...
const groceryList = createList(storeInventory);
